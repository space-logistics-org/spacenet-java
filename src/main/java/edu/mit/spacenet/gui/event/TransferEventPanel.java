...
public class TransferEventPanel extends AbstractEventPanel {
  ...
  private void initialize() {
    ...
    ddlOriginContainer.addItemListener(new ItemListener() {
      public void itemStateChanged(ItemEvent e) {
        if (e.getStateChange() == ItemEvent.SELECTED) {
          demandsTable.setData((I_ResourceContainer) ddlOriginContainer.getSelectedItem(),
              new DemandSet());
          updateView();
        }
      }
    ...
    if (event.getOriginContainer() != null && event.getOriginContainer() instanceof ResourceTank
        && event.getOriginContainer().getContainer() instanceof PropulsiveVehicle) {
      demandsTable.setData(((PropulsiveVehicle) getEventDialog()
          .getSimElement(((PropulsiveVehicle) event.getOriginContainer().getContainer()).getUid()))
              .getOmsFuelTank(),
          event.getTransferDemands());
      ...
      demandsTable.setData(((SurfaceVehicle) getEventDialog()
          .getSimElement(((SurfaceVehicle) event.getOriginContainer().getContainer()).getUid()))
              .getFuelTank(),
          event.getTransferDemands());
    } else if (event.getOriginContainer() != null) {
      demandsTable.setData(
          (I_ResourceContainer) getEventDialog().getSimElement(event.getOriginContainer().getUid()),
          event.getTransferDemands());
    }
  ...
  public void saveEvent() {
    if (demandsTable.isEditing())
      demandsTable.getCellEditor().stopCellEditing();
    if (ddlDestinationContainer.getSelectedItem() instanceof ResourceTank
        && ((ResourceTank) ddlDestinationContainer.getSelectedItem())
            .getContainer() instanceof PropulsiveVehicle) {
      PropulsiveVehicle vehicle =
          (PropulsiveVehicle) ((ResourceTank) ddlDestinationContainer.getSelectedItem())
              .getContainer();
      event.setDestinationContainer(
          ((PropulsiveVehicle) getEventDialog().getElement(vehicle.getUid())).getOmsFuelTank());
    } else if (ddlDestinationContainer.getSelectedItem() instanceof ResourceTank
        && ((ResourceTank) ddlDestinationContainer.getSelectedItem())
            .getContainer() instanceof SurfaceVehicle) {
      SurfaceVehicle vehicle =
          (SurfaceVehicle) ((ResourceTank) ddlDestinationContainer.getSelectedItem())
              .getContainer();
      event.setDestinationContainer(
          ((SurfaceVehicle) getEventDialog().getElement(vehicle.getUid())).getFuelTank());
    } else if (ddlDestinationContainer.getSelectedItem() instanceof I_ResourceContainer) {
      I_ResourceContainer container =
          (I_ResourceContainer) ddlDestinationContainer.getSelectedItem();
      event.setDestinationContainer(
          (I_ResourceContainer) getEventDialog().getElement(container.getUid()));
    }
    if (ddlOriginContainer.getSelectedItem() instanceof ResourceTank
        && ((ResourceTank) ddlOriginContainer.getSelectedItem())
            .getContainer() instanceof PropulsiveVehicle) {
      PropulsiveVehicle vehicle =
          (PropulsiveVehicle) ((ResourceTank) ddlOriginContainer.getSelectedItem()).getContainer();
      event.setOriginContainer(
          ((PropulsiveVehicle) getEventDialog().getElement(vehicle.getUid())).getOmsFuelTank());
      event.setTransferDemands(demandsTable.getTransferDemands());
        ...
        && ((ResourceTank) ddlOriginContainer.getSelectedItem())
            .getContainer() instanceof SurfaceVehicle) {
      SurfaceVehicle vehicle =
          (SurfaceVehicle) ((ResourceTank) ddlOriginContainer.getSelectedItem()).getContainer();
      event.setOriginContainer(
          ((SurfaceVehicle) getEventDialog().getElement(vehicle.getUid())).getFuelTank());
      event.setTransferDemands(demandsTable.getTransferDemands());
  ...
  public void updateView() {
    I_ResourceContainer destinationContainer =
        (I_ResourceContainer) ddlDestinationContainer.getSelectedItem();
    ...
    I_ResourceContainer originContainer =
        (I_ResourceContainer) ddlOriginContainer.getSelectedItem();
    ...
    if (destinationContainer != null && destinationContainer instanceof ResourceTank
        && destinationContainer.getContainer() instanceof PropulsiveVehicle) {
      ddlDestinationContainer.setSelectedItem(((PropulsiveVehicle) getEventDialog()
          .getSimElement(((PropulsiveVehicle) destinationContainer.getContainer()).getUid()))
              .getOmsFuelTank());
    } else if (destinationContainer != null && destinationContainer instanceof ResourceTank
        && destinationContainer.getContainer() instanceof SurfaceVehicle) {
      ddlDestinationContainer.setSelectedItem(((SurfaceVehicle) getEventDialog()
          .getSimElement(((SurfaceVehicle) destinationContainer.getContainer()).getUid()))
              .getFuelTank());
    } else if (destinationContainer != null
        && getEventDialog().getSimElement(destinationContainer.getUid()) != null) {
      ddlDestinationContainer
          .setSelectedItem(getEventDialog().getSimElement(destinationContainer.getUid()));
    }
    ddlDestinationContainer.addItemListener(destinationListener);
    if (originContainer != null && originContainer instanceof ResourceTank
        && originContainer.getContainer() instanceof PropulsiveVehicle) {
      ddlOriginContainer.setSelectedItem(((PropulsiveVehicle) getEventDialog()
          .getSimElement(((PropulsiveVehicle) originContainer.getContainer()).getUid()))
              .getOmsFuelTank());
      demandsTable.setData(((PropulsiveVehicle) getEventDialog()
          .getSimElement(((PropulsiveVehicle) originContainer.getContainer()).getUid()))
              .getOmsFuelTank(),
          demands);
    } else if (originContainer != null && originContainer instanceof ResourceTank
        && originContainer.getContainer() instanceof SurfaceVehicle) {
      ddlDestinationContainer.setSelectedItem(((SurfaceVehicle) getEventDialog()
          .getSimElement(((SurfaceVehicle) originContainer.getContainer()).getUid()))
              .getFuelTank());
      demandsTable.setData(((SurfaceVehicle) getEventDialog()
          .getSimElement(((SurfaceVehicle) originContainer.getContainer()).getUid())).getFuelTank(),
          demands);
      ...
      demandsTable.setData(
          (I_ResourceContainer) getEventDialog().getSimElement(originContainer.getUid()), demands);
    }
