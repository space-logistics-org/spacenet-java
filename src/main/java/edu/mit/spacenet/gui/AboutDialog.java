...
/**
 * Dialog that displays information about SpaceNet, including the version number, the authors, and
 * any licensing details.
 * 
 * @author Paul Grogan
 */
public class AboutDialog extends JDialog {
  ...
  private void buildDialog() {
    ...
    JLabel mitLogo =
        new JLabel(new ImageIcon(getClass().getClassLoader().getResource("icons/mit_footer.png")));
    mitLogo.setOpaque(false);
    contentPanel.add(mitLogo, c);
    c.gridy++;
    c.fill = GridBagConstraints.NONE;
    JLabel spaceNetLogo = new JLabel(
