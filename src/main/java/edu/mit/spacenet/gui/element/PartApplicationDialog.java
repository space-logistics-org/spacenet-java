...
public class PartApplicationDialog extends JDialog {
  ...
  private void initialize() {
    for (I_Item item : SpaceNetFrame.getInstance().getScenarioPanel().getScenario().getDataSource()
        .getItemLibrary()) {
  ...
  private boolean isPartValid() {
    if (partCombo.getSelectedItem() == null) {
      JOptionPane.showMessageDialog(this, "Please select a resource.", "SpaceNet Warning",
