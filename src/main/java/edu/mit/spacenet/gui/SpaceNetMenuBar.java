...
/**
 * The menu bar that contains all of the items in the pull-down menus. Most menu items use commands
 * which abstract the actual triggering of the various features so they can be used elsewhere (e.g.
 * exit on window close OR on selecting the exit command).
 * 
 * @author Paul Grogan
 */
public class SpaceNetMenuBar extends JMenuBar {
  ...
  private JMenuItem newScenarioMenuItem, openScenarioMenuItem, closeScenarioMenuItem,
      saveScenarioMenuItem, saveScenarioAsMenuItem, exitMenuItem, optionsMenuItem,
      dataSourceMenuItem, preferencesMenuItem, helpMenuItem, aboutMenuItem;
  private JRadioButtonMenuItem networkMenuItem, missionsMenuItem, demandsMenuItem, manifestMenuItem,
      simulationMenuItem;
  ...
  public void paint(Graphics g) {
    ...
    if (fileOpen) {
      networkMenuItem
          .setSelected(SpaceNetFrame.getInstance().getScenarioPanel().isEditingNetwork());
      missionsMenuItem
          .setSelected(SpaceNetFrame.getInstance().getScenarioPanel().isEditingMissions());
      demandsMenuItem
          .setSelected(SpaceNetFrame.getInstance().getScenarioPanel().isEditingDemands());
      manifestMenuItem
          .setSelected(SpaceNetFrame.getInstance().getScenarioPanel().isEditingManifest());
      simulationMenuItem
          .setSelected(SpaceNetFrame.getInstance().getScenarioPanel().isEditingSimulation());
    }
  }
  ...
  private void buildFileMenu() {
    ...
    saveScenarioAsMenuItem.setAccelerator(
