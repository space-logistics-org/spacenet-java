...
public class FlightTransport extends Event {
  ...
  public static FlightTransport createFrom(edu.mit.spacenet.simulator.event.FlightTransport event,
      Context context) {
  ...
  public edu.mit.spacenet.simulator.event.FlightTransport toSpaceNet(Context context) {
    edu.mit.spacenet.simulator.event.FlightTransport e =
        new edu.mit.spacenet.simulator.event.FlightTransport();
    e.setName(name);
    ...
    e.setEdge(
        (edu.mit.spacenet.domain.network.edge.FlightEdge) context.getJavaObjectFromJsonId(edge));
