...
/**
 * A custom JPanel that displays the details (both generic and class-specific) for an edge.
 * 
 * @author Paul Grogan
 */
public class EdgeDetailsPanel extends JPanel {
  ...
  private JLabel titleLabel, nodesLabel, descriptionLabel, distanceLabel, spaceDurationLabel,
      flightDurationLabel, maxCrewLabel, maxCargoLabel;
  private JPanel edgeDetailsPanel, surfaceEdgeDetailsPanel, spaceEdgeDetailsPanel,
      flightEdgeDetailsPanel;
