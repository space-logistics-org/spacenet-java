...
public class SpaceNet {
  ...
  public static void main(String[] args) {
    ...
    Option output = Option.builder("o").longOpt("output").argName("file path").hasArg()
        .desc("Output file path.").build();
  ...
  private static void saveScenario(Scenario scenario, boolean isOverwriteConfirmed) {
    ...
    if (file.exists() && !isOverwriteConfirmed) {
      ...
      do {
        System.out
            .println("Confirm to overwrite existing file " + scenario.getFilePath() + " (yes/no)");
  ...
  private static void convertScenario(String inputFilePath, String outputFilePath,
          ...
          protected Void doInBackground() {
            ...
            try {
              ...
              if (SpaceNetSettings.getInstance().getLastBounds() == null
                  ...
                  || virtualBounds.intersection(SpaceNetSettings.getInstance().getLastBounds())
                      .equals(new Rectangle())) {
                SpaceNetFrame.getInstance().setLocationRelativeTo(null);
                SpaceNetFrame.getInstance().setSize(new Dimension(1024, 768));
              } else {
                SpaceNetFrame.getInstance().setBounds(
                    virtualBounds.intersection(SpaceNetSettings.getInstance().getLastBounds()));
              }
