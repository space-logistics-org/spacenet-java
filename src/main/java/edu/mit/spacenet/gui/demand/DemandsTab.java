...
public class DemandsTab extends JSplitPane {
  ...
  public void initialize() {
    ...
    if (getScenario() != null) {
      ...
      aggregationSlider
          .setEnabled(getScenario().getItemDiscretization() != ItemDiscretization.NONE);
  ...
  private JPanel buildOptionsPanel() {
    ...
    scavengeSparesCheck
        .setToolTipText("Scavenge spare parts from co-located decommissioned elements");
  ...
  private void writeFile() {
    ...
    try {
      ...
      if (demandsCombo.getSelectedItem() == RAW_DEMANDS) {
        out.write("Time" + delimiter + "Location" + delimiter + "Element" + delimiter + "Resource"
        ...
        out.write("Time1" + delimiter + "Time2" + delimiter + "Node1" + delimiter + "Node2"
            + delimiter + "Resource" + delimiter + "Amount" + System.getProperty("line.separator"));
