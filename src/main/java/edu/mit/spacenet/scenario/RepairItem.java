...
public class RepairItem implements Comparable<RepairItem> {
  ...
  /**
   * The constructor takes the demand that was eliminated by repair, and the element that received
   * the repair.
   * 
  ...
  public String toString() {
    ...
    return demand + " (" + format.format(getMassToRepair()) + " kg, "
        + format.format(getMeanRepairTime()) + " hr)";
  }
