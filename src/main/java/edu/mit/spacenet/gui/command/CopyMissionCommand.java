...
/**
 * The command to copy a mission, performing all housekeeping operations to reset unique identifiers
 * and redirect pointers after serialization.
 * 
 * @author Paul Grogan
 */
    ...
    for (I_Event event : mission.getEventList()) {
      ...
      if (event instanceof CreateEvent) {
        ...
        if (((CreateEvent) event).getContainer() instanceof Node) {
          ...
          ((CreateEvent) event).setContainer(
              (I_Carrier) getElement(((I_Carrier) ((CreateEvent) event).getContainer()).getUid()));
        }
        ...
        if (((MoveEvent) event).getContainer() instanceof Node) {
          ...
          ((MoveEvent) event).setContainer(
              (I_Carrier) getElement(((I_Carrier) ((MoveEvent) event).getContainer()).getUid()));
        }
        ...
        ((EvaEvent) event)
            .setVehicle((I_Carrier) getElement(((EvaEvent) event).getVehicle().getUid()));
        ...
        ((ExplorationProcess) event)
            .setVehicle((I_Carrier) getElement(((ExplorationProcess) event).getVehicle().getUid()));
        ...
        ((SpaceTransport) event)
            .setEdge((SpaceEdge) getEdge(((SpaceTransport) event).getEdge().getTid()));
        ...
        ((SurfaceTransport) event)
            .setEdge((SurfaceEdge) getEdge(((SurfaceTransport) event).getEdge().getTid()));
        List<I_Element> elements = new ArrayList<I_Element>();
        ...
        ((FlightTransport) event)
            .setEdge((FlightEdge) getEdge(((FlightTransport) event).getEdge().getTid()));
        List<I_Element> elements = new ArrayList<I_Element>();
