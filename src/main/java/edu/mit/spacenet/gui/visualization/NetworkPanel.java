...
/**
 * The component that is used for network visualization. There are three layers: the body layer
 * displays the celestial bodies, the element layer displays the simulation elements, and the
 * network layer displays the nodes and edges.
 * 
