...
public class SavedOnlineDataSource implements I_SavedDataSource {
   ...
   */
  public SavedOnlineDataSource(String host, Integer port, String database, String user,
      String password) {
    this.host = host;
    this.port = port;
   ...
   * @param password the password
   */
  public SavedOnlineDataSource(String host, String database, String user, String password) {
  ...
  /**
   * Sets the password saved. If password is changed from saved to not saved, any existing password
   * is removed.
   * 
