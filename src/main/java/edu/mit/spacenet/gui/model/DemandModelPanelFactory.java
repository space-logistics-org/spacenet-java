...
public abstract class DemandModelPanelFactory {
   ...
   */
  public static AbstractDemandModelPanel createDemandModelPanel(DemandModelDialog demandModelDialog,
      I_DemandModel demandModel) {
    switch (demandModel.getDemandModelType()) {
      case CREW_CONSUMABLES:
        return new CrewConsumablesDemandModelPanel(demandModelDialog,
            (CrewConsumablesDemandModel) demandModel);
      case TIMED_IMPULSE:
        return new TimedImpulseDemandModelPanel(demandModelDialog,
      ...
      case SPARING_BY_MASS:
        return new SparingByMassDemandModelPanel(demandModelDialog,
