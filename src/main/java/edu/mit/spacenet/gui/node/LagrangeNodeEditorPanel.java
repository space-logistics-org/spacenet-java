...
public class LagrangeNodeEditorPanel extends AbstractNodeEditorPanel {
  ...
  private void buildPanel() {
    ...
    add(numberCombo, c);
    numberCombo.setToolTipText(
        "1: between bodies; 2: outside minor body; 3: outside major body; 4: leading triangular; 5: lagging triangular");
  ...
  public boolean isNodeValid() {
    ...
    if (majorBodyCombo.getSelectedItem() == null) {
      JOptionPane.showMessageDialog(getDialog(), "Please select a major celestial body.",
          "SpaceNet Warning", JOptionPane.WARNING_MESSAGE);
      return false;
    }
    if (minorBodyCombo.getSelectedItem() == null) {
      JOptionPane.showMessageDialog(getDialog(), "Please select a minor celestial body.",
          "SpaceNet Warning", JOptionPane.WARNING_MESSAGE);
      return false;
    }
    return true;
