...
public class CreateEvent extends AbstractEvent {
  ...
  /**
   * The default constructor initializes the set of items and sets a default name.
   */
  public CreateEvent() {
    super();
  ...
  public void execute(I_Simulator simulator) throws SimError {
    ...
    if (container instanceof I_Carrier && ((I_Carrier) container).getLocation() == null) {
    ...
    System.out.printf("%.3f: %s\n", getTime(), "Creating " + elements + " in " + container);
  ...
  /**
   * Gets the container at which to create the items. Null if creating at the specified Node.
   * 
