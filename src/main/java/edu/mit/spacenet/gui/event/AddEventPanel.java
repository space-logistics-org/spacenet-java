...
public class AddEventPanel extends AbstractEventPanel {
  ...
  private void buildPanel() {
    ...
    addDemandButton = new JButton("Add",
    ...
    removeDemandButton = new JButton("Remove",
  ...
  public void saveEvent() {
    event.setContainer((I_ResourceContainer) getEventDialog()
        .getElement((elementTree.getElementSelection().getUid())));
