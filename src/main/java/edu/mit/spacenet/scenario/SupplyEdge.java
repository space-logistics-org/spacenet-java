...
/**
 * A supply edge represents an abstraction of a transport along an edge that has the capability to
 * supply a location with resources.
 * 
 * @author Paul Grogan
 */
public class SupplyEdge implements Comparable<SupplyEdge> {
   ...
   */
  public SupplyEdge(Edge edge, boolean isReversed, double startTime, double endTime,
      Set<I_Carrier> carriers) {
    this.edge = edge;
  ...
  public String toString() {
    ...
    return getOrigin() + " (" + format.format(startTime) + ") - " + getDestination() + " ("
  ...
  public int compareTo(SupplyEdge edge) {
    if (endTime == edge.endTime)
      ...
      return new Double(endTime).compareTo(edge.endTime) * -1;
  }
  ...
  /**
   * Gets the origin node of the network edge, taking into account possible reversing.
   * 
  ...
  /**
   * Gets the destination node of the network edge, taking into account possible reversing.
   * 
  ...
  /**
   * Gets the capacity of the supply edge, measured by the excess cargo mass capacity of the
   * carriers.
   * 
  ...
  /**
   * Gets the raw capacity of the supply edge, measured by the maximum cargo mass capacity of the
   * carriers.
   * 
  ...
  /**
   * Gets the capacity of the supply edge, measured by the excess cargo volume capacity of the
   * carriers.
   * 
  ...
  /**
   * Gets the raw capacity of the supply edge, measured by the maximum cargo volume capacity of the
   * carriers.
   * 
  ...
  /**
   * Gets a set of all carriers (independent of nesting order) associated with the supply edge.
   * 
   * @return the set of carriers
   */
