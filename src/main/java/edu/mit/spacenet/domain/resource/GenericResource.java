...
public class GenericResource extends Resource {
  ...
  /**
   * The constructor that assigns a TID of -COS and a (unit) mass of 1. It also sets the class of
   * supply and creates a generic name based on it.
   * 
  ...
  /**
   * Constructor that sets the class of supply and environment. Also assigns a TID of -COS and a
   * (unit) mass of 1.
   * 
   * @param classOfSupply the resource class of supply
  ...
  public double getUnitVolume() {
    if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS1))
      return 1900 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS201))
      return 1 / 1000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS2))
      return 7000 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS3))
      return 5000 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS4))
      return 3000 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS5))
      return 7000 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS6))
      return 5000 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS7))
      return 5000 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS8))
      return 3500 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS9))
      return 3500 / 1000000d;
    else if (getClassOfSupply().isInstanceOf(ClassOfSupply.COS10))
      return 7000 / 1000000d;
    else
      return super.getUnitVolume();
  }
