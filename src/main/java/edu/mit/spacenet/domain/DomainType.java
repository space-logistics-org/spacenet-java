...
/**
 * The domain type class is used to assign identification numbers to objects pulled from the data
 * source. A domain type is used to differentiate static objects like locations, and also
 * object-types like element types.
 * 
 * @author Paul Grogan
 */
public abstract class DomainType implements I_DomainType {
  ...
  /**
   * The default constructor automatically assigns the type identifier to negative random number and
   * assigns a default name of "".
   */
  public DomainType() {
  ...
  public boolean equals(Object object) {
    /*
     * Due to the serialization process used in SpaceNet, domain types (i.e. locations, states,
     * etc.) must use type identification numbers instead of memory addresses to determine equality.
     */
    if (object instanceof DomainType && getClass().equals(object.getClass()))
