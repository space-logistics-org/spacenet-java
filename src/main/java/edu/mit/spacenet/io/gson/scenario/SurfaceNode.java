...
public class SurfaceNode extends Node {
  ...
  public static SurfaceNode createFrom(edu.mit.spacenet.domain.network.node.SurfaceNode node,
      Context context) {
  ...
  public edu.mit.spacenet.domain.network.node.SurfaceNode toSpaceNet(Context context) {
    edu.mit.spacenet.domain.network.node.SurfaceNode n =
        new edu.mit.spacenet.domain.network.node.SurfaceNode();
