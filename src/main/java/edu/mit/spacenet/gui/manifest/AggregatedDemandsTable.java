...
/**
 * A table for visualizing aggregated demands, and the portion of each demand that has been packed.
 * 
 * @author Paul Grogan
 */
  ...
  public AggregatedDemandsTable(ManifestTab manifestTab) {
    ...
    getColumnModel().getColumn(0).setCellRenderer(new DefaultTableCellRenderer() {
      ...
      public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
        ...
        if (getManifest().isEdgeDemand(getDemand(row)))
          setText(getText() + "*");
        return this;
      }
    });
    ...
    getColumnModel().getColumn(2).setCellRenderer(new DefaultTableCellRenderer() {
      ...
      public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
        ...
        setText(format.format(value) + " "
            + ((AggregatedDemandsTableModel) getModel()).getDemand(row).getResource().getUnits());
        return this;
      }
    });
  ...
  private class AggregatedDemandsTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int row, int col) {
      if (col == 0)
        ...
        return getManifest().getPackedAmount(getDemand(row));
    }
