...
public class ResourceContainerPanel extends AbstractElementPanel {
  ...
  private void buildPanel() {
    ...
    c.weighty = 1;
    resourcesList = new DemandTable(SpaceNetFrame.getInstance().getScenarioPanel().getScenario()
    ...
    removeResourceButton = new JButton("Remove",
  ...
  public void saveElement() {
    if (resourcesList.isEditing())
      resourcesList.getCellEditor().stopCellEditing();
