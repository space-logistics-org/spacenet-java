...
public class SurfaceVehiclePanel extends AbstractElementPanel {
  ...
  private void buildPanel() {
    ...
    resourceCombo.addItemListener(new ItemListener() {
      public void itemStateChanged(ItemEvent e) {
        if (e.getStateChange() == ItemEvent.SELECTED && resourceCombo.getSelectedItem() != null) {
  ...
  public void saveElement() {
    ...
    vehicle.getFuelTank().setAmount(
        Math.min(maxFuelModel.getNumber().doubleValue(), fuelModel.getNumber().doubleValue()));
  ...
  public boolean isElementValid() {
    if ((maxFuelModel.getNumber().doubleValue() > 0 || fuelModel.getNumber().doubleValue() > 0)
