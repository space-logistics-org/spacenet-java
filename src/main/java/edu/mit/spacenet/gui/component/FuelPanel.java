...
public class FuelPanel extends JPanel {
  ...
  public void updateFuel(PropulsiveVehicle vehicle) {
    if (vehicle.getOmsFuelTank() != null) {
      ...
      omsCapacity.setValue((int) (100 * vehicle.getOmsFuelTank().getAmount()
          / vehicle.getOmsFuelTank().getMaxAmount()));
    ...
    if (vehicle.getRcsFuelTank() != null && vehicle.getRcsFuelTank() != vehicle.getOmsFuelTank()) {
      rcsLabel.setVisible(true);
      rcsCapacity.setVisible(true);
      rcsCapacity.setValue((int) (100 * vehicle.getRcsFuelTank().getAmount()
          / vehicle.getRcsFuelTank().getMaxAmount()));
  ...
  public void updateFuel(SurfaceVehicle vehicle) {
    ...
    fuelCapacity.setValue(
        (int) (100 * vehicle.getFuelTank().getAmount() / vehicle.getFuelTank().getMaxAmount()));
