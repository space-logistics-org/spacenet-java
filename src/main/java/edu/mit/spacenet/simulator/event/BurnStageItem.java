...
/**
 * This class represents an entry into a burn/stage list, either a burn of a propulsive vehicle, or
 * a staging of an expended element.
 * 
 * @author Paul Grogan
 */
public class BurnStageItem {
  ...
  public static final ImageIcon BURN_ICON =
      new ImageIcon(BurnStageItem.class.getClassLoader().getResource("icons/bullet_red.png"));

  /** The Constant STAGE_ICON. */
  public static final ImageIcon STAGE_ICON =
      new ImageIcon(BurnStageItem.class.getClassLoader().getResource("icons/bullet_black.png"));
  ...
  public String toString() {
    if (burnStage.equals(BURN))
      return "[B] " + element;
    else if (burnStage.equals(STAGE))
      return "[S] " + element;
    else
      return "";
  }
