...
/**
 * Interface for a simulator that executes events and updates a network of objects.
 * 
 * @author Paul Grogan
 */
public interface I_Simulator {
  ...
  /**
   * Gets the aggregated set of demands associated with a mission, filtered by a class of supply.
   * 
   * @param mission the mission
  ...
  /**
   * Gets the aggregated set of demands associated with an element during a mission.
   * 
   * @param mission the mission
   * @param element the element
   * 
  ...
  /**
   * Gets the aggregated set of demands associated with an element during a mission, filtered by a
   * class of supply.
   * 
   * @param mission the mission
   * @param element the element
  ...
  /**
   * Gets the aggregated set of demands associated with an element, filtered by a class of supply.
   * 
   * @param element the element
   * @param cos the class of supply
   * 
  ...
  /**
   * Gets the aggregated set of demands from a location, filtered by a class of supply.
   * 
   * @param location the location
   * @param cos the class of supply
   * 
