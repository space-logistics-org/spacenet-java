...
public class BurnStageActions {
	...
	public static List<BurnStageActions> createFrom(List<edu.mit.spacenet.domain.network.edge.Burn> burns, List<List<edu.mit.spacenet.simulator.event.BurnStageItem>> sequence, Context context) {
	...
	public static List<List<edu.mit.spacenet.simulator.event.BurnStageItem>> toSpaceNet(SpaceEdge edge, Collection<BurnStageActions> sequence, Context context) {
		List<List<edu.mit.spacenet.simulator.event.BurnStageItem>> as = new ArrayList<List<edu.mit.spacenet.simulator.event.BurnStageItem>>();
