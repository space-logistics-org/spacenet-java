...
public class MissionPanel extends JPanel {
  ...
  private void buildPanel() {
    ...
    ddlReturnDestination.addItemListener(new ItemListener() {
      public void itemStateChanged(ItemEvent e) {
        missionSplitPane.getMission()
            .setReturnDestination((Node) ddlReturnDestination.getSelectedItem());
      }
    });
    ...
    eventsTable.addMouseListener(new MouseAdapter() {
      public void mouseClicked(MouseEvent e) {
        if (e.getClickCount() == 2 && eventsTable.getSelectedRow() >= 0) {
          ...
          EventDialog.createAndShowGUI(getThis(),
    ...
    btnRemoveEvent = new JButton("Remove",
    ...
    btnRemoveEvent.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        int answer = JOptionPane.showOptionDialog(missionSplitPane, warningPanel, "Warning",
    ...
    JButton btnOk = new JButton("Save",
        new ImageIcon(getClass().getClassLoader().getResource("icons/application_go.png")));
