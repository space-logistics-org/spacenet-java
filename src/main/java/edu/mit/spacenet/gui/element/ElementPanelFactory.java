...
/**
 * An abstract class that contains a factory method to build the appropriate combination of element
 * panels.
 * 
...
public abstract class ElementPanelFactory {
  ...
  /**
   * A factory method that returns a list of element panels appropriate for viewing and editing the
   * element.
   * 
   ...
   */
  public static List<AbstractElementPanel> createElementPanel(ElementDialog elementDialog,
      I_Element element) {
