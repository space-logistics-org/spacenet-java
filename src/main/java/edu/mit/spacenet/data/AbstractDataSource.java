...
public abstract class AbstractDataSource implements I_DataSource {
  ...
  public void print() {
    ...
    for (Node n : nodeLibrary) {
      System.out.println(
          "\t" + n.getTid() + ": " + n.getName() + " (" + n.getClass().getSimpleName() + ") ");
    }
    System.out.println("Edge Library:");
    for (Edge e : edgeLibrary) {
      System.out.println(
          "\t" + e.getTid() + ": " + e.getName() + " (" + e.getClass().getSimpleName() + ") ");
    }
    System.out.println("Resource Library:");
    for (I_Resource r : resourceTypeLibrary) {
      System.out.println(
          "\t" + r.getTid() + ": " + r.getName() + " (COS " + r.getClassOfSupply().getId() + ") ");
    }
    ...
    for (I_DemandModel o : demandModelLibrary) {
      System.out
          .println("\t" + o.getTid() + ": " + o.getName() + " (" + o.getDemandModelType() + ") ");
    }
  }
   ...
   */
  public final void loadLibraries(boolean updateNodes, boolean updateEdges, boolean updateResources)
      throws Exception {
