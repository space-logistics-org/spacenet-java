...
public interface I_Event extends Comparable<I_Event> {
  ...
  /**
   * Gets the priority of this event over other events with the same time (Lowest value first).
   * 
  ...
  /**
   * Sets the priority of this event over other events with the same time (Lowest value first).
   * 
  ...
  /**
   * Gets the location that the event will act at (in the case of processes, this returns the
   * initial location.
   * 
   * @return the node
   */
  ...
  /**
   * Sets the location that the event will act at (in the case of processes, this sets the initial
   * location.
   * 
