...
/**
 * A custom drop down button containing the options to add the different kinds of mission-level
 * demand models to a mission.
 */
public class AddMissionDemandModelButton extends DropDownButton {
  ...
  public AddMissionDemandModelButton(MissionPanel missionPanel) {
    super("Add Model", new ImageIcon(
        missionPanel.getClass().getClassLoader().getResource("icons/comment_add.png")));
  ...
  private void addMenuItems() {
    JMenuItem addImpulseDemandModel = new JMenuItem(DemandModelType.TIMED_IMPULSE.getName(),
    ...
    addImpulseDemandModel.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DemandModelDialog.createAndShowGUI(missionPanel, DemandModelFactory.createDemandModel(
            missionPanel.getMissionSplitPane().getMission(), DemandModelType.TIMED_IMPULSE));
      }
    });
    getMenu().add(addImpulseDemandModel);
    JMenuItem addRatedDemandModel =
    ...
    addRatedDemandModel.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        DemandModelDialog.createAndShowGUI(missionPanel, DemandModelFactory.createDemandModel(
            missionPanel.getMissionSplitPane().getMission(), DemandModelType.RATED));
      }
    });
    getMenu().add(addRatedDemandModel);
    JMenuItem addCrewConsumablesDemandModel = new JMenuItem(
        DemandModelType.CREW_CONSUMABLES.getName(), DemandModelType.CREW_CONSUMABLES.getIcon());
    ...
    addCrewConsumablesDemandModel.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        CrewConsumablesDemandModel model =
            new CrewConsumablesDemandModel(missionPanel.getMissionSplitPane().getMission());
