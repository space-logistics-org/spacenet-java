...
public class ReconfigureEventPanel extends AbstractEventPanel {
  ...
  private void initialize() {
    ...
    if (event.getElement() != null
        && getEventDialog().getSimElement(event.getElement().getUid()) != null) {
      elementTree.setSelection(getEventDialog().getSimElement(event.getElement().getUid()));
      for (I_State simState : getEventDialog().getSimElement(event.getElement().getUid())
          .getStates()) {
  ...
  public void saveEvent() {
    ...
    if (elementTree.getElementSelection() != null) {
      event.setElement(
          getEventDialog().getElement(((I_Element) elementTree.getElementSelection()).getUid()));
