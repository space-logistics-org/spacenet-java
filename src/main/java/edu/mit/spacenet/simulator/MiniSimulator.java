...
public class MiniSimulator extends AbstractSimulator {
  ...
  public void simulate() {
    ...
    while (getEvents().peek() != null) {
      ...
      handleDemands(); // TODO 7/12/2010: added demand cycle in for pre-manifested resources
  ...
  /**
   * Gets a list of states representing the location history during the simulation.
   * 
